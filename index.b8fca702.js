...
var _productinfoJs = require("./productinfo.js");
window.onload = ()=>{
    (0, _productinfoJs.Refresh)();
};
...
},{"bootstrap":"h36JB","./productinfo.js":"9lTTV"}],"h36JB":[function(require,module,exports) {
/*!
...
},{"./createPopper.js":"cHuNp","./modifiers/eventListeners.js":"hBKsL","./modifiers/popperOffsets.js":"6I679","./modifiers/computeStyles.js":"gDlm2","./modifiers/applyStyles.js":"4iMn4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9lTTV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "cars", ()=>cars);
parcelHelpers.export(exports, "cars_list", ()=>cars_list);
parcelHelpers.export(exports, "car_template", ()=>car_template);
parcelHelpers.export(exports, "addCars", ()=>addCars);
parcelHelpers.export(exports, "Refresh", ()=>Refresh);
var _localstorageJs = require("./localstorage.js");
const cars = (0, _localstorageJs.readFromLocalStorage)((0, _localstorageJs.LS_KEY));
const cars_list = document.querySelector(".load_cars");
const car_template = document.querySelector("car_item");
const addCars = (car)=>{
...
},{"./localstorage.js":"jIvPc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jIvPc":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "LS_KEY", ()=>LS_KEY);
parcelHelpers.export(exports, "readFromLocalStorage", ()=>readFromLocalStorage);
parcelHelpers.export(exports, "saveToLocalStorage", ()=>saveToLocalStorage);
const Product = (photo, name, description, price)=>{
    if (typeof photo !== "string" || typeof name !== "string" || typeof description !== "string" || typeof price !== "number") throw new Error("Invalid product data");
    return {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["8bDoD","3cYfC"], "3cYfC", "parcelRequirea06b")
